...
import com.sudao.cloud.module.entity.ActivityInfo;
import com.sudao.cloud.module.service.tomodel.GeneralService;
import com.sudao.cloud.module.service.toservice.ResourceServiceGenerator;
import com.sudao.cloud.module.service.totable.EntityClassScan;
...
@MapperScan(basePackages = {"com.sudao.cloud.module.service.mapper"})
    ...
    public CommandLineRunner generalCodeCommand() {
        return (args) -> {
            ...
            if (null != generalTableSwitch && generalTableSwitch.equals("on")) {
                ...
                classScan.excludeClass(ActivityInfo.class);
